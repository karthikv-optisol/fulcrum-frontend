...
export class ReportsListComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private fb: FormBuilder,
     public modalService: NgbModal, private httpClient: HttpClient, private route: ActivatedRoute,
      private componentFactoryResolver: ComponentFactoryResolver, private elementRef: ElementRef, private ReportsListService: ReportsListService, private router: Router, private titleService: Title, private renderer: Renderer2, private commonService: CommonService, private loader: LoaderService) {
